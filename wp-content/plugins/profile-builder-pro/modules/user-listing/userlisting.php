...
function wppb_userlisting_extra_search_all_fields( $value, $name, $children, $extra_info ){
	...
	return '
		<form method="post" action="'.esc_url( add_query_arg( array( 'page' => 1, 'setSortingCriteria' => $setSortingCriteria, 'setSortingOrder' => $setSortingOrder ) ) ).'" class="wppb-search-users wppb-user-forms">
