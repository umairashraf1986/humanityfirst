...
class WonderPlugin_Slider_View {
	...
	function print_overview() {
		...
		<h2><?php echo __( 'Wonder Slider', 'wonderplugin_slider' ) . " " . ((WONDERPLUGIN_SLIDER_VERSION_TYPE == "C") ? "Commercial" : ((WONDERPLUGIN_SLIDER_VERSION_TYPE == "L") ? "Lite" : "Free")) . " Version " . WONDERPLUGIN_SLIDER_VERSION; ?> </h2>
