...
<!--====  Geographic Regions  ====-->
<section class="blog-content regions-content our-work-programs page-wrapper">
    ...
    <div class="row hf-gl-row">
      ...
      <?php while ($loop->have_posts()) : $loop->the_post();
        ...
        if ($sortOrder != '' && $sortOrder > 0) {
          ...
          <div class="col-lg-3 col-md-6 col-sm-12?>">
            ...
            <div class="hf-gl-item-img test">
              <a href="<?php the_permalink(); ?>">
                <?php if (!get_the_post_thumbnail_url()) {?>
                  <img src="<?php echo get_template_directory_uri().'/assets/images/placeholder_wc_img.jpg'; ?>"
                       alt="<?php the_title(); ?>"/>
                <?php }else{
                  ?>
      ...
      <?php
        ...
        if (!get_the_post_thumbnail_url()) {
          $image = '<img src="'.get_template_directory_uri().'/assets/images/placeholder_wc_img.jpg'.'"
           alt="'.get_the_title().'"/>';
        }else{
