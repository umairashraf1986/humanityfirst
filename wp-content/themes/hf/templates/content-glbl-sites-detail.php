                ...
                <div class="widgets">
                    <div class="sidebar-styling widget" style="border: none;">
                        ...
                        <div class="text-center">
                          <?php
                          $link = rwmb_meta("hfusa-glbl_website");
                          if(isset($link) && $link !=''):?>
                            <a href="<?php echo rwmb_meta("hfusa-glbl_website");?>" target="_blank" class="btn btn-blue"><i class="fa fa-globe" aria-hidden="true"></i> Visit their website</a>
                          <?php endif;?>
                        </div>
                    </div>
                    <?php
