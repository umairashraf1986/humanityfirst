    ...
    <div class="hf-grid-layout hf-gl-news">
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="hf-gl-header">
                        <ul class="hf-filter hf-news-filter">
                            ...
                            <li><a href="#!" data-filter=".featured"><i class="fa fa-bookmark-o"></i> Featured</a></li>
                            <li><a href="#!" data-filter=".popular"><i class="fa fa-bolt"></i> Popular</a></li>
                            <li><a href="#!" data-filter=".gift-of-sight"> Gift Of Sight</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <?php $program = get_page_by_path('gift-of-sight', OBJECT, 'hf_programs');
            $thumbnail = wp_get_attachment_url(get_post_meta($program->ID, 'hfusa-program_logo', true));
            $color = get_post_meta($program->ID, 'hfusa-program_color', true);
            ?>
            <div class="row hf-gl-row hf-filter-grid">

                <?php $loop = new WP_Query(array('post_type' => 'post', 'category_name' => 'blog', 'posts_per_page' => -1)); ?>
                <?php while ($loop->have_posts()) : $loop->the_post(); ?>
                    ...
                    ?>
                    <div class="hf-grid-item col-lg-3 col-md-6 col-sm-12<?php echo $category_names; ?>">
                            ...
                            <div class="hf-gl-wrapper" style="display: flex; flex-direction: column;">
                                <div class="hf-gl-item-cat">
                                    ...
                                    if (in_category('Featured')) { ?>
                                        <span class="post-on blog-date"><i
                                    ...
                                    if ($tumblrID != '') {
                                        echo '<span class="tumblr-post mr-3"><i class="fa fa-tumblr-square"></i></span>';
                                    }
                                ...
                                <div class="hf-gl-item-meta" style="margin-top: 0;">
                                    <span class="post-by"><i
                                                class="fa fa-user-circle"></i> <?php echo get_the_author(); ?></span>
                                    <div class="share-post-div">
                                        ...
                                        <div id="share-icons-list" class="share-icons-list">
                                            <ul class="social-list">
                                                ...
                                                <li>
                                                    <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php the_permalink(); ?>&title=<?php the_title(); ?>&summary=&source="
            ...
            <!--<div class="col-lg-12 load-more text-center">
                <button type="button" class="btn btn-primary btn-load-more" id="blog-load-more" data-offset="0">
                    Show More
                </button>
            </div>-->
        </div>
