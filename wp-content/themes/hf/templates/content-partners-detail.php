        ...
        <div class="widgets">
          <div class="sidebar-styling widget" style="border: none;">
            <div class="img-wrapper justify-content-center text-center">
              <div class="director-img-wrapper" style="border: none; border-radius: 0;">
                <img alt="" class="director-img" src="<?php echo get_the_post_thumbnail_url(); ?>" style="border-radius: 0; object-fit: contain;" />
              </div>
            </div>
            <h4 class="text-center color-primary"></h4>
            <?php
            $partner_website = rwmb_meta('hfusa-partner_website');
            if ($partner_website != "") {
              echo '<div class="text-center"><a href="'. $partner_website .'" target="_blank" class="btn btn-blue"><i class="fa fa-globe" aria-hidden="true"></i> Visit their website</a></div>';
            }
            ?>
          </div>
          ...
          <div class="widget">
            <div class="widget-content">
              ...
              <ul class="detail-page-social">
                ...
                if (rwmb_meta('hfusa-partner_facebook') != "") {
                  echo '<li><a href="'.rwmb_meta('hfusa-partner_facebook').'" target="_blank" class="icon-facebook"><i class="fa fa-facebook"></i></a></li>';
                }
                if (rwmb_meta('hfusa-partner_twitter') != "") {
                  echo '<li><a href="'.rwmb_meta('hfusa-partner_twitter').'" target="_blank" class="icon-twitter"><i class="fa fa-twitter"></i></a></li>';
                }
                if (rwmb_meta('hfusa-partner_linkedin') != "") {
                  echo '<li><a href="'.rwmb_meta('hfusa-partner_linkedin').'" target="_blank" class="icon-linkedin"><i class="fa fa-linkedin"></i></a></li>';
                }
                if (rwmb_meta('hfusa-partner_google_plus') != "") {
                  echo '<li><a href="'.rwmb_meta('hfusa-partner_google_plus').'" target="_blank" class="icon-google-plus"><i class="fa fa-google-plus"></i></a></li>';
                }
                if (rwmb_meta('hfusa-partner_email') != "") {
                  echo '<li><a href="mailto:'.rwmb_meta('hfusa-partner_email').'" class="icon-email"><i class="fa fa-envelope-o"></i></a></li>';
                }
                ?>
              </ul>
