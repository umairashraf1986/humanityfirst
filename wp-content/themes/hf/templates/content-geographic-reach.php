          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 float-left">
              <div class="widgets">
                            ...
                            <div class="row d-flex align-items-center">
                              <div class="col-lg-4 col-sm-2 col-md-2 st-left float-left w-auto">
                                <div class="icon-container">
                                  <img src="<?php echo get_template_directory_uri();?>/assets/images/geographic-reach.png" alt="Geographic Reached">
                                </div>
                              </div>
                              <div class="col-lg-8 col-sm-10 col-md-6 st-right float-left w-flex">
                                <div class="dts-figures">
                                  <h4><span>12.35 <span>K</span></span></h4>
                                  <h6>Registered Operations</h6>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <?php
                  // $loop_countries = new WP_Query( array( 'post_type' => 'hf_countries', 'posts_per_page' => -1 ) );
                  // if( $loop_countries->have_posts() ) {
                ?>
                ...
                <div class="widget" style="display: none;">
                  ...
                  <div class="t-map-statistics">
                    <div class="tms-header">
                      <h5>Countries We Reached</h5>
                    </div>
                    <div class="tms-body">
                      <?php // while( $loop_countries->have_posts() ) : $loop_countries->the_post(); ?>
                      <div class="tms-list-item">
                        <!-- <div class="flag-container">
                          <img src="<?php echo get_template_directory_uri(); ?>/usa-states-flags/Hawaii.png" alt="">
                        </div> -->
                        <div class="country-details">
                          <h5><a href="<?php // the_permalink(); ?>" class="color-primary"><?php // the_title(); ?></a></h5>
                        </div>
                      </div>
